  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-[#0ab2bd] mb-8">
          商捷SUNJI知识库
        </h1>
        <a
          ...
          className="group inline-flex items-center justify-center gap-3 rounded-xl bg-[#0ab2bd] px-20 py-7 text-2xl font-bold text-white shadow-[0_8px_30px_rgba(10,178,189,0.4)] transition-all duration-300 hover:bg-[#099aa3] hover:shadow-[0_12px_40px_rgba(10,178,189,0.5)] animate-breathe"
        >
