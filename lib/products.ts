...
export const products: ProductDevice[] = [
  ...
  },
  {
    ...
    name: "商捷碰一碰终端",
    image: "t3b0b.png",
    images: ["t3b0b-first-new.png", "t3b0b-second-new.jpg", "t3b0b-front.png", "t3b0b-back.png"],
    model: "T3B0B",
    os: "安卓11，商米OS",
    storage: "4G + 64G",
    businessMode: "半自助",
  ...
  },
  {
    ...
    name: "商捷融合终端",
    image: "t3b0a.png",
    images: ["t3b0a-t.png", "t3b0a-right-t.png", "t3b0a-left-t.png"],
    model: "T3B0A",
    os: "安卓11，商米OS",
    storage: "4G + 64G",
    businessMode: "半自助",
  ...
  },
  {
    ...
    name: "商捷手持终端",
    image: "t6f01.png",
    images: ["t6f01.png", "t6f01-multi.png"],
    model: "T6F01",
    os: "安卓11，商米OS",
    storage: "2G + 64G",
    businessMode: "全自助 / 半自助",
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "处理器", value: "ARM 6核，主频达1.8GHz" },
